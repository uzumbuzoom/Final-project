...
The average life expectancy between `r params$start_year ` and `r params$end_year ` for people by birth in `r params$start_year ` was `r round((df$life.exp.by.birth[df$year >= params$start_year]))`
