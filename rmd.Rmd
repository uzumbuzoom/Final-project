...
The average life expectancy between `r params$start_year ` and `r params$end_year ` for people by 65 years old in `r params$start_year ` was `r mean((df$life.exp.by.65[df$year >= params$start_year & df$year <= params$end_year][1]))`
...
The average life expectancy between `r params$start_year ` and `r params$end_year ` for people by birth in `r params$start_year ` was `r mean((df$life.exp.by.birth[df$year >= params$start_year & df$year <= params$end_year][1]))`
